    ...
    public List<String> getLines(Player player) {
        ...
        switch (NUHC.getInstance().getGameState()) {
            ...
            case IN_GAME:
                ...
                toReturn.add("");
                toReturn.add(ChatColor.GREEN + "Your Kills: " + ChatColor.WHITE + NUHC.getInstance().getUhcPlayerManager().getPlayer(player.getUniqueId()).getStats().getStat(StatType.KILLS));
